 ...
 *
 * <p>Represents a single segment of transcribed text with its start and end times, text content,
 * and optional confidence score. Segments are used to provide time-aligned transcription results.
 *
 * @author shangmin
 * @version 1.0
 * @since 2024
