 ...
 *
 * <p>This interface defines the contract for audio transcription services, including direct
 * transcription, asynchronous job submission, and job progress tracking. Implementations handle
 * communication with the Python transcription service and provide validation and error handling.
 *
 * @author shangmin
 * @version 1.0
 * @since 2024
...
public interface AudioService {
   ...
   * @throws com.shangmin.whisperrr.exception.TranscriptionProcessingException if transcription
   *     fails
   */
   ...
   * @throws com.shangmin.whisperrr.exception.FileValidationException if file validation fails
   * @throws com.shangmin.whisperrr.exception.TranscriptionProcessingException if job submission
   *     fails
   */
