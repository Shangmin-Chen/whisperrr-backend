 ...
 *
 * <p>This controller provides HTTP endpoints for audio transcription operations, including direct
 * transcription, asynchronous job submission, and job progress tracking. It handles multipart file
 * uploads and delegates business logic to the AudioService.
 *
 * @author shangmin
 * @version 1.0
 * @since 2024
